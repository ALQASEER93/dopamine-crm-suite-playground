---
name: dpm-environment-warning-triage
description: Classify Codex CLI, doctor, MCP, browser, and reachability warnings as blocking or non-blocking.
---

# dpm-environment-warning-triage

## Purpose
Classify Codex CLI, doctor, MCP, browser, and reachability warnings as blocking or non-blocking.
