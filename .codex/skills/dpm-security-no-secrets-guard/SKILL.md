---
name: dpm-security-no-secrets-guard
description: Scan evidence and proposed artifacts for secret exposure and unsafe logging patterns.
---

# dpm-security-no-secrets-guard

## Purpose
Scan evidence and proposed artifacts for secret exposure and unsafe logging patterns.
