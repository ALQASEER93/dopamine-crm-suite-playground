---
name: dpm-service-worker-cache-bust-check
description: Review service worker, manifest, and build-version cache-bust proof without modifying product code.
---

# dpm-service-worker-cache-bust-check

## Purpose
Review service worker, manifest, and build-version cache-bust proof without modifying product code.
