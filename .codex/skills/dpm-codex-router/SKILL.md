---
name: dpm-codex-router
description: Route DPM work to Codex App, CLI, Cloud/Web, ChatGPT, MCP tools, or human-only approval.
---

# dpm-codex-router

## Purpose
Route DPM work to Codex App, CLI, Cloud/Web, ChatGPT, MCP tools, or human-only approval.
