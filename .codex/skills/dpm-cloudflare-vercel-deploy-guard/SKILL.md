---
name: dpm-cloudflare-vercel-deploy-guard
description: Keep deploy/DNS/Cloudflare/Vercel actions human-only and verify same-origin API assumptions read-only.
---

# dpm-cloudflare-vercel-deploy-guard

## Purpose
Keep deploy/DNS/Cloudflare/Vercel actions human-only and verify same-origin API assumptions read-only.
