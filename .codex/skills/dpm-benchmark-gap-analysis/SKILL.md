---
name: dpm-benchmark-gap-analysis
description: Compare DPM capabilities against pharma field force CRM benchmark patterns.
---

# dpm-benchmark-gap-analysis

## Purpose
Compare DPM capabilities against pharma field force CRM benchmark patterns.
