---
name: dpm-no-localhost-production-guard
description: Find localhost, 127.0.0.1, or direct browser Vercel API risks before release claims.
---

# dpm-no-localhost-production-guard

## Purpose
Find localhost, 127.0.0.1, or direct browser Vercel API risks before release claims.
