---
name: dpm-field-rep-abuse-red-team
description: Generate abuse scenarios for rep location spoofing, duplicate sync, RBAC bypass, and export leakage.
---

# dpm-field-rep-abuse-red-team

## Purpose
Generate abuse scenarios for rep location spoofing, duplicate sync, RBAC bypass, and export leakage.
