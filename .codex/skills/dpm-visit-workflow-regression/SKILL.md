---
name: dpm-visit-workflow-regression
description: Protect Start Visit / End Visit, timestamp, accuracy, GPS, status, and export behavior.
---

# dpm-visit-workflow-regression

## Purpose
Protect Start Visit / End Visit, timestamp, accuracy, GPS, status, and export behavior.
