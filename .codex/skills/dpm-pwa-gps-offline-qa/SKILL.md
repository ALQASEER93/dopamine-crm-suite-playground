---
name: dpm-pwa-gps-offline-qa
description: Review PWA, GPS, offline queue, idempotency, and sync evidence before field readiness claims.
---

# dpm-pwa-gps-offline-qa

## Purpose
Review PWA, GPS, offline queue, idempotency, and sync evidence before field readiness claims.
