---
name: dpm-pr-evidence-pack
description: Build a clean report/json/log/zip evidence pack for review without push or merge.
---

# dpm-pr-evidence-pack

## Purpose
Build a clean report/json/log/zip evidence pack for review without push or merge.
