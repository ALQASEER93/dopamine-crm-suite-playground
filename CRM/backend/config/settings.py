...
class Settings(BaseSettings):
    ...
    gps_max_distance_m: float = Field(default=150.0, validation_alias="GPS_MAX_DISTANCE_M")
    gps_min_accuracy_m: float = Field(default=50.0, validation_alias="GPS_MIN_ACCURACY_M")
    geofence_radius_m: float = Field(default=150.0, validation_alias="GEOFENCE_RADIUS_M")
