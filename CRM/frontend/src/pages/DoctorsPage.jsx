...
const DoctorsPage = () => {
  ...
  const createMutation = useMutation({
    ...
    onError: error => {
      setFormError(error.message || 'تعذر حفظ الطبيب');
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: error => {
      setFormError(error.message || 'تعذر تحديث الطبيب');
    },
  });
    ...
    <div className="entity-page">
      ...
      <section className="table-card entity-table">
        ...
        {!doctorsQuery.error && doctorsQuery.isLoading && (
          <div className="entity-empty">جاري تحميل الأطباء...</div>
        )}
        {!doctorsQuery.error && !doctorsQuery.isLoading && doctors.length === 0 && (
          <div className="entity-empty">لا يوجد أطباء للفلاتر المختارة.</div>
        )}
