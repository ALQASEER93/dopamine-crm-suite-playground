---
description: "Antigravity workflow for Data & Integrations."
---
...
@docs/AGENTS/agents/06_DATA_INTEGRATIONS.md
...
- Produce a single report file: docs/_runs/run_<timestamp>/artifacts/DATA_INTEGRATIONS_REPORT.md.
- Log to docs/_runs/run_<timestamp>/logs/data-integrations.log.
...
Task:
- Execute the Data & Integrations mission from the attached docs.
