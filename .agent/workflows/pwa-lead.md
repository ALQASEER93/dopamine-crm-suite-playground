---
description: "Antigravity workflow for PWA Lead."
---
...
@docs/AGENTS/agents/05_PWA_LEAD.md
...
- Produce a single report file: docs/_runs/run_<timestamp>/artifacts/PWA_LEAD_REPORT.md.
- Log to docs/_runs/run_<timestamp>/logs/pwa-lead.log.
...
Task:
- Execute the PWA Lead mission from the attached docs.
